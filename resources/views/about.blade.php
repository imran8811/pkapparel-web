...
<div class="col-12 page-about">
  <div class="row">
    ...
    <div class="col-lg-8 mb-5">
      <h1 class="page-title">Jeans Manufacturing Company</h1><br />
      <div class="row">
        <div class="col-6 mb-3">
          <img src="/images/img3.jpg" alt="about img" class="img-thumbnail" />
        </div>
        <div class="col-6">
          <img src="/images/img2.jpg" alt="about img" class="img-thumbnail" />
        </div>
      </div>
      ...
      <h2>Team</h2>
      <p>We have a team backed by skilled, experienced, responsible and well educated Merchandisers and Managers to
      ...
      <div class="row mb-5 mt-5">
        <div class="col-6">
          <img src="/images/img4.jpg" alt="about img" class="img-thumbnail" />
        </div>
        <div class="col-6">
          <img src="/images/img5.jpg" alt="about img" class="img-thumbnail" />
        </div>
      </div>
      <h3>Quality</h3>
