...
<div class="col-12 page-about">
  <div class="row">
    <div class="col-12 mb-5">
      <h2 class="text-info">Fabric Store</h2>
      <ul class="mb-3">
    ...
    <div class="col-12 mb-5">
      <h2 class="text-info">Fabric Cutting</h2>
      <ul class="mb-3">
    ...
    <div class="col-12 mb-4">
      <h2 class="text-info">Stitching</h2>
      <ul class="mb-3">
      ...
      <div class="row">
        <div class="col-lg-6 p-2">
          <img src="/images/jeans-manufacturers.jpg" alt="jeans-manufacturers" class="img-fluid" />
        </div>
        <div class="col-lg-6 p-2">
          <img src="/images/denim-shirts-wholesaler.jpg" alt="denim-shirts-wholesaler" class="img-fluid" />
        </div>
      </div>
    </div>
    <div class="col-12 mb-4">
      <h2 class="text-info">Washing</h2>
      <ul class="mb-3">
      ...
      <div class="row">
        <div class="col-lg-6">
          <img src="/images/denim-manufacturers.jpg" alt="denim-manufacturers" class="img-fluid" />
        </div>
        <div class="col-lg-6">
          <img src="/images/denim-pants-suppliers-china.jpg" alt="denim-pants-suppliers-china" class="img-fluid" />
        </div>
      </div>
    </div>
    <div class="col-12 mb-4">
      <h2 class="text-info">Quality</h2>
      <ul class="mb-3">
        <li><strong>Area = 5000 x 5000 sqft</strong></li>
      ...
      <div class="row">
        <div class="col-lg-6">
          <img src="/images/jeans-quality.jpg" alt="jeans-pants-wholesalers" class="img-fluid" />
        </div>
      </div>
    </div>
    <div class="col-12 mb-4">
      <h2 class="text-info">Packing</h2>
      <ul class="mb-3">
      ...
      <div class="row">
          <div class="col-lg-6">
            <img src="/images/jeans-shirts-manufacturers.jpg" alt="jeans-shirts-manufacturers" class="img-fluid" />
          </div>
          <div class="col-lg-6">
            <img src="/images/jeans-wholesalers.jpg" alt="jeans-wholesalers" class="img-fluid" />
          </div>
      </div>
    </div>
  </div>
